...
--seed 0 --batch_size 40 --num_workers 4 --image_height 128 --image_width 128 --image_channels 3 --log_path logs/ \
...
--data_path '/app/clevr_images/train/images/*.png' \
--checkpoint_path '/app/clevr-4_rect/best_model.pt'
