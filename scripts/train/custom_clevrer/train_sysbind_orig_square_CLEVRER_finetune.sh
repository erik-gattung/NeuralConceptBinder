...
--lr_dvae 7e-7 --lr_enc 5e-5 --lr_dec 1e-3 --lr_warmup_steps 1 --lr_half_life 2 --clip 0.05 \
--epochs 4 --num_iterations 3 --num_slots 4 --num_blocks 16 --cnn_hidden_size 512 --slot_size 2048 \
--mlp_hidden_size 192 --num_prototypes 64 --vocab_size 4096 --num_decoder_layers 8 --num_decoder_heads 4 \
--d_model 192 --dropout 0.1 --tau_start 1.0 --tau_final 0.5 --tau_steps 4 --use_dp --temp 1. \
