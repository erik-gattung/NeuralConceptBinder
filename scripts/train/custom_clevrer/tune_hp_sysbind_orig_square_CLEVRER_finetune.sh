...
#-------------------------------------------------------------------------------#
CUDA_VISIBLE_DEVICES=$DEVICE python -m sysbinder.optuna_train \
...
--d_model 192 --dropout 0.1 --tau_start 0.1 --tau_final 0.1 --tau_steps 5 --use_dp --temp 1. \
--contrastive_loss_temp 0.4 --contrastive_loss_weight 0.1 --ce_weight 1.0 \
